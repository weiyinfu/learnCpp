...
string DES_Encrypt(const string cleartext, const string key, CRYPTO_MODE mode) {
    ...
    switch (mode) {
        ...
        case CBC: {
            ...
            DES_ncbc_encrypt((const unsigned char *) cleartext.c_str(), tmp, cleartext.length() + 1, &keySchedule,
                             &ivec, DES_ENCRYPT);
        ...
        case TRIPLE_CBC: {
            ...
            DES_ede3_cbc_encrypt((const unsigned char *) cleartext.c_str(), tmp, cleartext.length() + 1, &ks1, &ks2,
                                 &ks3, &ivec, DES_ENCRYPT);
...
string DES_Decrypt(const string ciphertext, const string key, CRYPTO_MODE mode) {
    ...
    switch (mode) {
        ...
        case CBC: {
            ...
            DES_ncbc_encrypt((const unsigned char *) ciphertext.c_str(), tmp, ciphertext.length() + 1, &keySchedule,
                             &ivec, DES_DECRYPT);
        ...
        case TRIPLE_CBC: {
            ...
            DES_ede3_cbc_encrypt((const unsigned char *) ciphertext.c_str(), tmp, ciphertext.length() + 1, &ks1, &ks2,
                                 &ks3, &ivec, DES_DECRYPT);
